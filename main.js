...
function apiSearch(e) {
    ...
    fetch("https://api.themoviedb.org/3/search/multi?api_key=d86ca64010d84d9a3269a45fbe212bc5&language=ru&query=" + searchText)
    .then((value) => {
        if(value.status !== 200){
...
function showFullInfo(){
 ...
 if (this.dataset.type === 'movie'){
     url = `https://api.themoviedb.org/3/movie/${this.dataset.id}?api_key=d86ca64010d84d9a3269a45fbe212bc5&language=ru`;
 } else if(this.dataset.type === 'tv'){
    url = `https://api.themoviedb.org/3/tv/${this.dataset.id}?api_key=d86ca64010d84d9a3269a45fbe212bc5&language=ru`;
 } else {
...
document.addEventListener('DOMContentLoaded', () => {
    fetch('https://api.themoviedb.org/3/trending/all/week?api_key=d86ca64010d84d9a3269a45fbe212bc5&language=ru')
    .then((value) => {
        if(value.status !== 200){
            return Promise.reject(new Error(value.status))
        }
